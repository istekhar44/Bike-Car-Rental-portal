  ...
  return (
    <motion.div
      ...
      <div className='text-white'>
        <h2 className='text-3xl font-medium'>Own a Vehicle? Start Earning Today!</h2>
        <p className='mt-2'>List your car, bike, scooter, or truck on VehicleRental and monetize it effortlessly.</p>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className='px-6 py-2 bg-white hover:bg-slate-100 transition-all text-primary rounded-lg text-sm mt-4 cursor-pointer'>List Your Vehicle</motion.button>
      </div>
