        ...
        <motion.div
            ...
            <div className='flex flex-col items-center gap-5'>
                <motion.h1 initial={{ y: 50, opacity: 0 }}
                    ...
                    <span className='bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-500 bg-clip-text text-transparent'>Drive Your Way- Anytime, Anywhere</span>
                    <br />
                    <span className='text-slate-800'>Trusted Rentals for Every Journey</span>
                </motion.h1>
                <motion.p initial={{ y: 30, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.4 }}
                    className='text-gray-500 text-base md:text-lg max-w-xl leading-relaxed'>
                    Cars, bikes, scooters & more — find and book the perfect ride in seconds.
                </motion.p>
            </div>
